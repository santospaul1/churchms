...
from .views import CustomLoginView, RegisterView, add_location, admin_dashboard, contact, contact_list, contact_success, dashboard, delete_location, edit_location, location_list, member_dashboard, user_logout
